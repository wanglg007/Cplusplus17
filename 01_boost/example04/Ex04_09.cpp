//Stable vector example
#include <boost/container/stable_vector.hpp>
#include <cassert>
#include <string>

/**
 * stable_vector does not store the objects in a contiguous memory layout.
 * Because of the extra pointers and indirections, stable_vector tends to be slower than std::vector, but that is the trade-off for stable iterators.
 * @return
 */
int main() {
