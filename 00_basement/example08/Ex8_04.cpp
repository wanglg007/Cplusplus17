//(8.4)Using decltype() inside a function template
#include <iostream>
#include <vector>
#include <algorithm>    // for std::min()

// Template that computes a so-called "inner product" of two vectors. Both vectors are supposed to be equally long,
